# AI × System Dynamics — Survey Results
...
AI-optimism composite, and the demographic factors that significantly shift
opinion. It is mobile-friendly and readable on small screens.

_Currently showing synthetic test data; replace `index.html` with the final run
once real responses are collected._
